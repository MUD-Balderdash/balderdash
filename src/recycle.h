...
***************************************************************************/
/* $Id: recycle.h,v 1.12.2.7 2007/10/10 16:33:37 key Exp $ */
...
/* challenger recycling */
#define CL CHALLENGER_DATA
CL	*new_challenger args( (void) );
void	free_challenger args( (CHALLENGER_DATA *challenger) );
#undef CL

/* score recycling */
#define SC SCORE_DATA
SC	*new_score args( (void) );
void	free_score args( (SCORE_DATA *score) );
#undef SC

/* recipe recycling */
#define RE RECIPE_DATA
RE	*new_recipe args( (void) );
void	free_recipe args( (RECIPE_DATA *recipe) );
#undef RE

/* query recycling */
#define QR QUERY_DATA
QR	*new_query args( (void) );
void	free_query args( (QUERY_DATA *query) );
#undef QR
...
GROUP_QUEST_DATA *new_group_quest();
