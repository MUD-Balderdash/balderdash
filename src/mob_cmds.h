 ...
 *                                                                         *
 ***************************************************************************/
/* $Id: mob_cmds.h,v 1.12.2.2 2006/09/25 08:15:46 key Exp $ */
...
DECLARE_DO_FUN(	do_mpsetskill	);
DECLARE_DO_FUN(	do_mprestore	);
DECLARE_DO_FUN(	do_mpdoor	);
DECLARE_DO_FUN(	do_mplog	);
DECLARE_DO_FUN(	do_mpholylight	);
DECLARE_DO_FUN( do_mpaddapply	);
...
DECLARE_OBJ_FUN( do_oplog	 );
DECLARE_OBJ_FUN( do_opflags	 );
DECLARE_OBJ_FUN( do_oplag	 );
DECLARE_OBJ_FUN(	do_oppeace	);
...
DECLARE_ROOM_FUN( do_rpdoor	 );
DECLARE_ROOM_FUN( do_rplog	 );
DECLARE_ROOM_FUN( do_rplag	 );
DECLARE_ROOM_FUN( do_rppeace	);
#endif
/* charset=cp1251 */
