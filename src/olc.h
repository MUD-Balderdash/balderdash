 ...
 *                                                                         *
 ***************************************************************************/
/* $Id: olc.h,v 1.22.2.11 2007/05/16 02:14:28 Shagrad Exp $ */
...
void return_affects args( (OBJ_INDEX_DATA *pObj, bool add) );
...
DECLARE_OLC_FUN( oedit_require		);
DECLARE_OLC_FUN( oedit_comments		);

DECLARE_OLC_FUN( oedit_uncomfortable	);
DECLARE_OLC_FUN( oedit_unusable		);
...
DECLARE_OLC_FUN( medit_sector		);
DECLARE_OLC_FUN( medit_message		);
DECLARE_OLC_FUN( medit_chat		);
DECLARE_OLC_FUN( medit_clan		);
DECLARE_OLC_FUN( medit_rating		);
...
#define EDIT_CKEY(Ch, ChatKey)	( ChatKey = (CHAT_KEYS *) Ch->desc->pEdit	)
...
#define EDIT_CLASS(Ch, Class)	( Class = (struct class_type *) Ch->desc->pEdit )
#define EDIT_GROUP(Ch, Group)	( Group = (struct group_type *) Ch->desc->pEdit )
...
/* Skills/spells editor */
DECLARE_OLC_FUN( skedit_show            );
DECLARE_OLC_FUN( skedit_name            );
DECLARE_OLC_FUN( skedit_rname           );
DECLARE_OLC_FUN( skedit_fun             );
DECLARE_OLC_FUN( skedit_target          );
DECLARE_OLC_FUN( skedit_minpos          );
DECLARE_OLC_FUN( skedit_minmana         );
DECLARE_OLC_FUN( skedit_beats           );
DECLARE_OLC_FUN( skedit_gsn          	);
DECLARE_OLC_FUN( skedit_msgdam          );
DECLARE_OLC_FUN( skedit_genderdam       );
DECLARE_OLC_FUN( skedit_msgoff          );
DECLARE_OLC_FUN( skedit_msgobj          );
DECLARE_OLC_FUN( skedit_msgroom         );

/* Groups editor */
DECLARE_OLC_FUN( gredit_show            );
DECLARE_OLC_FUN( gredit_name            );
DECLARE_OLC_FUN( gredit_rname           );
...
DECLARE_OLC_FUN( cledit_wname           );
DECLARE_OLC_FUN( cledit_weapon          );
DECLARE_OLC_FUN( cledit_primary         );
DECLARE_OLC_FUN( cledit_secondary       );
DECLARE_OLC_FUN( cledit_hp_min          );
DECLARE_OLC_FUN( cledit_hp_max          );
DECLARE_OLC_FUN( cledit_skill_adept     );
DECLARE_OLC_FUN( cledit_fmana           );
DECLARE_OLC_FUN( cledit_mtitle          );
DECLARE_OLC_FUN( cledit_ftitle          );
DECLARE_OLC_FUN( cledit_skills          );
DECLARE_OLC_FUN( cledit_thac0           );
DECLARE_OLC_FUN( cledit_guilds          );
DECLARE_OLC_FUN( cledit_align           );
DECLARE_OLC_FUN( cledit_base_group      );
DECLARE_OLC_FUN( cledit_default_group   );
DECLARE_OLC_FUN( cledit_groups          );

/* Race editor */
DECLARE_OLC_FUN( raedit_show		);
DECLARE_OLC_FUN( raedit_name		);
DECLARE_OLC_FUN( raedit_mname		);
DECLARE_OLC_FUN( raedit_fname		);
...
DECLARE_OLC_FUN( raedit_recall		);
DECLARE_OLC_FUN( raedit_map		);
DECLARE_OLC_FUN( raedit_align		);
DECLARE_OLC_FUN( raedit_str		);
DECLARE_OLC_FUN( raedit_int		);
DECLARE_OLC_FUN( raedit_wis		);
DECLARE_OLC_FUN( raedit_dex		);
DECLARE_OLC_FUN( raedit_con		);
DECLARE_OLC_FUN( raedit_skill		);
DECLARE_OLC_FUN( raedit_class		);
		
/* ChatBook editor */
DECLARE_OLC_FUN( cedit_show	        );
DECLARE_OLC_FUN( cedit_regexp	        );
DECLARE_OLC_FUN( cedit_create	        );
DECLARE_OLC_FUN( cedit_reply	        );
